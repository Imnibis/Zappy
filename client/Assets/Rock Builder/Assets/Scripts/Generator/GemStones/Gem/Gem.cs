    ...
    public class Gem : MonoBehaviour
    {
        ...
        private void OnDrawGizmosSelected()
        {
            if (vertexPositions != null)
            {
                ...
                vertexPositions = GemMeshGenerator.Instance.CreateVertexPositions(this);
                GemPreview.Instance.DrawGizmo(this);
            }
        }

        public void RemoveGemClass()
        {
            DestroyImmediate(this.GetComponent<Gem>());
        }
